---
{"dg-publish":true,"permalink":"/30-database/kajian/support-system-untuk-sabar/","tags":["kajian"]}
---
...
- Sub Materi: Sabar
- Tanggal: 2025-11-22T00:00:00.000+07:00
- Link Kajian: https://www.youtube.com/watch?v=6fpLzrAsFj4
...
- Sabar adalah salah satu karakteristik adab menuntut ilmu.
	...
	- [[30 - Database/Kajian/Sabar di jalan Allah menyingkap hakikat dan mengefisiensikan waktu\|Sabar di jalan Allah menyingkap hakikat dan mengefisiensikan waktu]]
...
- **Contoh kisah**: 
	- Kisah Siti Hajar yang ditinggalkan bersama anaknya Nabi Ismail oleh Ibrahim As, kalimat yang diucapkan Siti Hajar adalah
		- Apakah ini perintah ***Allah ﷻ*** ?
		- Kalau ini memang perintah Allah, maka Allah pasti tidak akan menyia-nyiakan kami.
	- Kisah ***Nabi ﷺ*** bersama Abu Bakar ketika di gua Tsur. ***Nabi ﷺ*** menenangkan dan bersabda "Janganlah bersedih, ***Allah ﷻ*** bersama kita"
		- 
...
## Kadar pertolongan sesuai level ujian
- ***Nabi ﷺ*** bersabda dari sanad Abu Hurairah (sahih), "Sesungguhnya pertolongan dari ***Allah ﷻ*** datang kepada kita sesuai dengan **kadar** **ujian**."
- Jika ujian level nya 6 maka pertolongannya 6. Perintahnya berat maka pertolongan banyak.
- Dalam menjalankan perintah, wajar jika akan mendapat ujian, tetapi yakinlah akan ada pertolongan dari ***Allah ﷻ*** . 
- Sebagaimana perjuangan dakwah ***Nabi ﷺ*** dari sebelum dan sampai hijrah, selama 21 tahun ***Nabi ﷺ*** berjuang sampai klimaksnya pertolongan ***Allah ﷻ*** dalam fathul Makkah.
- Jangan **terburu-buru** langsung ingin mendapatkan pertolongan.
...
2. Beliau melanjutkan untuk bisa sabar kita perlu menggabungkan 2 unsur
	1. Ilmu
	2. Amal
3. Dengan dua unsur di atas **teraciklah** **obat** **hati** yang paling mujarab yaitu sabar.
4. Tanpa salah satu unsur di atas maka sabar tidak akan berhasil.
5. **Contoh kasus**: 
	1. seperti orang yang belajar ujian tulis berenang tapi tanpa nyemplung
...
2. Baru bicara bagaimana teknis kita menyampaikan secara komprehensif
3. **Kejujuran** **lebih** **penting** daripada kemampuan verbal / **retorika**, karena rapot kita di tangan mereka :) 
4. Banyak orang tua yang berubah bukan karena anaknya menjelaskan melainkan
	1. Menjaga shalat setelah lama lalai
	2. Biayain umrah / haji
